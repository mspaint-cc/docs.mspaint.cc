...
If you want lucide icon support, save the [lucide icon registry](https://raw.githubusercontent.com/mstudio45/lucide-roblox-direct/refs/heads/main/source.lua) as a modulescript and require it.
