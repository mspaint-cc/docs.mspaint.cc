...
<TypeTable
  type={{
    ...
    Animations: {
      ...
      type: 'table',
      default: '{ ToggleWindow = false, TabSwitch = false, Dropdown = false }',
      required: false
    },
    TabTransitionTime: {
...
<Tabs items={['ToggleWindow', 'TabSwitch', 'Dropdown']}>
...
```lua
Window:SetAnimations({ ToggleWindow = true, TabSwitch = true, Dropdown = true }, 0.22, 26, "bottom")
```
