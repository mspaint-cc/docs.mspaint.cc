...
Undocks or docks the groupbox. When undocked, the header stays fixed and a tall body scrolls without a visible scrollbar (height is clamped to the screen with a bottom gap).
