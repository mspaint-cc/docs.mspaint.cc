...
To learn more about the available elements and their arguments, check out the [Obsidian](https://github.com/deividcomsono/Obsidian/blob/main/Example.lua) documentation (Groupbox is essentially `:AddGroupbox()` from Obsidian).
