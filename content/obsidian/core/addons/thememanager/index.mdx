...
| --- | --- | --- | --- |
| 1 | Library returned by `Library.lua` | Library | nil |
...
| Arg Idx | Argument Description | Type | Default |
| --- | --- | --- | --- |
| 1 | Theme name without extension | string | nil |
...
| Arg Idx | Argument Description | Type | Default |
| --- | --- | --- | --- |
| 1 | Groupbox returned by `AddLeftGroupbox`/`AddRightGroupbox` | table | nil |
...
| Arg Idx | Argument Description | Type | Default |
| --- | --- | --- | --- |
| 1 | Groupbox to populate | table | nil |
