...
The `Window` object is your base UI container. It hosts tabs, groupboxes, notifications and everything else driven by the library. The next step to using the library is to [create a tab inside the window](../structure/tabs).
...
<TypeTable
  type={{
    ...
    MobileButtonsSide: {
      description: 'Side to place mobile buttons',
      type: '"Left" | "Right"',
      default: '"Left"',
      required: false
    },
