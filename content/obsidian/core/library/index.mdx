...
The `Window` object is your base UI container. It hosts tabs, groupboxes, notifications and everything else driven by the library, so configuring it well keeps the rest of the experience tidy.
