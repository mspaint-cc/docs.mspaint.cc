  ...
  return (
    <button
      ...
      className={cn(
        buttonVariants({
          color: 'secondary',
          className: 'gap-2 px-2.5 py-1.5 text-sm [&_svg]:size-3.5 [&_svg]:text-fd-muted-foreground',
        }),
        props.className,
      )}
    >
    ...
    <Popover>
      <PopoverTrigger
        ...
        className={cn(
          ...
          'gap-2 px-2.5 py-1.5 text-sm data-[state=open]:bg-fd-accent data-[state=open]:text-fd-accent-foreground',
          props.className,
        )}
      >
        {props.children ?? 'Open'}
